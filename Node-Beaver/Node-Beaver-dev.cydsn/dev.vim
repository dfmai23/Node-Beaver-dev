...
silent only
cd /cygdrive/c/Users/jgtao/psoc/Node-Beaver/Node-Beaver/Node-Beaver.cydsn
...
badd +0 sd_manager.c
badd +0 sd_manager.h
badd +0 usb_manager.c
badd +0 usb_manager.h
badd +0 radio_manager.c
badd +0 radio_manager.h
badd +29 can_manager.c
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 14 - ((6 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
14
